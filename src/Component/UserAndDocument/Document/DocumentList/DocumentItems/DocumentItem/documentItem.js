...
export default class DocumentItem {
    ...
    render() {
        ...
        const $li = createNewElement("li", [{ property: "className", value: "document__item"}, { property: "dataset.id", value: id }]);
        const $title = createNewElement("span", [{ property: "className", value: "document__item__title"}], title);
        const $buttons = createNewElement("div", [{ property: "className", value: "document__buttons"}]);
        const $insert = createNewElement("button", [{ property: "className", value: "document__buttons__insert"}], "+");
        const $delete = createNewElement("button", [{ property: "className", value: "document__buttons__delete"}], "-");

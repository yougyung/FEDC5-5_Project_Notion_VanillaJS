...
export default class DocumentItem {
    ...
    render() {
        ...
        const $insert = createNewElement("button", [{ property: "className", value: "document__buttons--insert"}], "+");
        const $delete = createNewElement("button", [{ property: "className", value: "document__buttons--delete"}], "-");
